...
<div
    class="success-stories bg-gradient-to-br from-quicksilver-500 to-quicksilver-600 py-24 px-4 xl:px-0 overflow-hidden text-quicksilver-25">
    ...
    <div class="mx-auto grid grid-cols-1 gap-8 text-center max-w-md md:text-left lg:grid-cols-3 lg:max-w-6xl md:px-0">

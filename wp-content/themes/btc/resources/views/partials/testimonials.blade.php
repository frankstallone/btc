        ...
        <figure class="my-0 border border-quicksilver-50 rounded-lg shadow-md pt-8 bg-white">
            ...
            <figcaption class="font-medium text-emeraldCity-500 px-8 pt-10 pb-4 mt-10 border-t relative">
                ...
                <strong>Raphael Akinsete</strong> recommends Builders Trust Capital <small
                    class="text-right mt-2 text-quicksilver-100 block">Oct.
                    11, 2020</small>
            </figcaption>
        </figure>
        <figure class="my-0 border border-quicksilver-50 rounded-lg shadow-md pt-8 bg-white">
            ...
            <figcaption class="font-medium text-emeraldCity-500 px-8 pt-10 pb-4 mt-10 border-t relative">
                ...
                <strong>Kristian Latham</strong> recommends Builders Trust Capital <small
                    class="text-right mt-2 text-quicksilver-100 block">Aug.
                    2020</small>
            </figcaption>
        </figure>
        <figure class="my-0 border border-quicksilver-50 rounded-lg shadow-md pt-8 bg-white">
            ...
            <figcaption class="font-medium text-emeraldCity-500 px-8 pt-10 pb-4 mt-10 border-t relative">
                ...
                <strong>John Allen</strong> recommends Builders Trust Capital <small
                    class="text-right mt-2 text-quicksilver-100 block">Mar.
                    2020</small>
            </figcaption>
        </figure>
        <figure class="my-0 border border-quicksilver-50 rounded-lg shadow-md pt-8 bg-white">
            <blockquote class="border-none px-8">
                <p class="text-lg my-0">
                    ...
                    been able to work with my unique situations and helped us closed on properties no one else could.

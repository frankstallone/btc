<div class="quick-contact bg-quicksilver-800 py-12 px-12">
    <div class="sm:w-full sm:max-w-xl mx-auto py-12 px-4 md:px-0">
        ...
        <div>
            ...
            <p class="text-center text-quicksilver-50 mb-12">Just contact us by phone 856-422-3232 or email
                loans@builderstrustcapital.com. If you prefer, send us a message and we’ll contact you shortly. Let’s
                get started working together.</p>
        </div>
        <div>

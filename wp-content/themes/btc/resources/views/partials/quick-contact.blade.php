...
<div
    class="css-content-visibility flex quick-contact bg-gradient-to-bl from-quicksilver-800 to-quicksilver-900 py-24 px-4 min-h-80 relative overflow-hidden">
    <?php echo $btcQuick; ?>

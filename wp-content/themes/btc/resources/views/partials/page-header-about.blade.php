<header class="headliners bg-gradient-to-tr from-quicksilver-700 to-quicksilver-800 overflow-hidden relative">
    ...
    <div class="mx-auto max-w-3xl px-4 py-20 relative z-10">
        <h1 class="text-quicksilver-50">Builders Trust Capital is a Direct Lender </h1>
        <h2 class="text-quicksilver-100 mb-0">We’re here to help real estate investors succeed</h2>
    </div>
</header>

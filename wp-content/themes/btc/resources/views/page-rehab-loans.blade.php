...
<div class="prose mx-auto grid grid-cols-1 gap-4 py-8 px-4 md:grid-cols-3 md:grid-rows-2 md:max-w-4xl">
...
<div class="prose mx-auto grid grid-cols-1 gap-4 py-8 px-4 md:grid-cols-2 md:max-w-3xl">
  <div class="border-2 rounded-lg border-quicksilver-50 p-8">
    <h2 class="mt-0 mb-0 important">Fix & Flip Preferred</h2>
    <h3 class="mt-0 important">Loan Program</h3>
    <figure class="mb-0 important"><table><tbody><tr><td>90% LTC up to 75% LTARV</td></tr><tr><td>Rates as low as 9%</td></tr><tr><td>Points as low as 2%</td></tr><tr><td>Loans from $75,000 and up</td></tr><tr><td>Interest is escrowed</td></tr><tr><td>Loan is managed in-house, not outsourced. Ensures consistent service during and after origination</td></tr></tbody></table></figure>
  </div>
  <div class="border-2 rounded-lg border-quicksilver-50 p-8">
    <h2 class="mt-0 mb-0 important">Fix & Flip Standard</h2>
    <h3 class="mt-0 important">Loan Program</h3>

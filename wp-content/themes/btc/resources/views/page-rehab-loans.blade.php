...
<div class="bg-goldRush-50">
  <div class="sm:w-full sm:max-w-xl mx-auto py-12 px-4 md:px-0">
    ...
    <p class="text-xl text-goldRush-900 mb-0">Ideal for investors looking to purchase a property, renovate and then sell or rent the renovated property for a profit. You can also use the loan for the refinance and rehab when you’ve started using cash and need a loan to finish the project. Credit score 720 & up.</p>
  </div>
</div>
...
<div class="mx-auto grid grid-cols-1 gap-4 py-8 px-4 sm:grid-cols-2 sm:max-w-3xl md:px-0">
  <div class="border-2 rounded-lg border-quicksilver-50 p-8">
    ...
    <figure class="mb-0"><table><tbody><tr><td>90% LTC up to 75% LTARV</td></tr><tr><td>Rates as low as 9%</td></tr><tr><td>Points as low as 2%</td></tr><tr><td>Loans from $75,000 and up</td></tr><tr><td>Interest is escrowed</td></tr><tr><td>Loan is managed in-house, not outsourced. Ensures consistent service during and after origination</td></tr></tbody></table></figure>
  </div>
  <div class="border-2 rounded-lg border-quicksilver-50 p-8">
    <h2 class="mt-0 mb-0">Fix & Flip Standard</h2>
    <h3 class="mt-0">Loan Program</h3>
    <figure class="mb-0"><table><tbody><tr><td>85% LTC up to 75% LTARV</td></tr><tr><td>Rates as low as 10%</td></tr><tr><td>Points as low as 2%</td></tr><tr><td>Loans from $75,000 and up</td></tr><tr><td>Interest is escrowed</td></tr><tr><td>Loan is managed in-house, not outsourced. Ensures consistent service during and after origination</td></tr></tbody></table></figure>
  </div>
</div>
